...
class DetailDokterOnlinePage extends StatefulWidget {
  final int doctorId;

  const DetailDokterOnlinePage({super.key, required this.doctorId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailDokterOnlinePageState createState() => _DetailDokterOnlinePageState();
}

class _DetailDokterOnlinePageState extends State<DetailDokterOnlinePage> {
